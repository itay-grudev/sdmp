...
class SRPTransport : public Aio::Handler {
public:
    explicit SRPTransport(const std::shared_ptr<Tcp::Handler>& handler);
    SRPTransport(const SRPTransport&) = delete;
    SRPTransport& operator=(const SRPTransport&) = delete;
