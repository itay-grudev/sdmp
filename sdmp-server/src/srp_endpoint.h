...
public:
    ...
    SRPEndpoint();
    explicit SRPEndpoint(const Address& addr);
...
void listenAndServe(Address addr, const SRPEndpoint::Options& options = SRPEndpoint::options())
{
    SRPEndpoint endpoint(addr);
